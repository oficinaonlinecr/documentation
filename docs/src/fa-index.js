...
const allIcons = require('../node_modules/vuepress-plugin-font-awesome/lib/all')
const solidIcons = require('../node_modules/vuepress-plugin-font-awesome/lib/solid')

// keys of icons
let keys = Object.keys(allIcons);
let solidKeys = Object.keys(solidIcons);

let defaultDotVuepressFolder = '/docs/src/.vuepress';
